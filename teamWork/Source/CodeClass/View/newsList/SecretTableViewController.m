...
@property(strong,nonatomic) NSMutableArray * SecretLifeArray;
...
-(NSMutableArray *)SecretLifeArray
{
    if (!_SecretLifeArray) {
        _SecretLifeArray = [NSMutableArray array];
    }
    return _SecretLifeArray;
}
...
- (void)viewDidLoad {
    ...
    //注册cell
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:SLID];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return self.SecretLifeArray.count;
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:SLID forIndexPath:indexPath];
